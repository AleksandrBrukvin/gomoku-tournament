...
import gomoku.Game.PlayerScore;
import gomoku.Game.PlayerScoreConf;
import gomoku.Game.PlayerScoreValue;
...
public class Game {
	 ...
	 *
	 */
	public static class PlayerScoreValue {
		public int wins = 0;
		public int losses = 0;
		public int draws = 0;
	...
	public static class PlayerScores {
		...
		public static ObservableList<GameStats> getGameStats(String strategy) {
		...
		public static PlayerStats getPlayerStats(String strategy) {
			Player player = GomokuTournamentController.getPlayerbyName(strategy);
			PlayerScore ps = scores.get(player);
			if (ps == null) {
				System.out.println("No information about player:" + player);
			...
			return new PlayerStats(player.getName(),strategy,wins,draws,losses,(int)winRate);
		}
	}
